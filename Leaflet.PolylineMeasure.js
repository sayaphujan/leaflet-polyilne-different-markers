...
(function (factory) {
    ...
    var _measurePinId = 'polyline-measure-pin';
    ...
    L.Control.PolylineMeasure = L.Control.extend({
        ...
        options: {
            ...
            unitPinUnits: ["home" , "pedastal", "handhole"],
            /**
        ...
        onAdd: function(map) {
            ...
            if (this.options.showPinControl && this.options.unitPinUnits.length > 1) {
                var label = this.options.unitPinLabel[this.options.pin];
                var title = this.options.unitPinTitle.text + " [" + this.options.unitPinTitle[this.options.pin]  + "]";

                var classes = this.options.unitPinClasses;
                this._unitPin = this._createControl (label, title, classes, this._container, this._changePin, this);
                this._unitPin.setAttribute ('id', 'unitPinId');
            }
        ...
        _changePin: function() {
            // Retrieve the index of the next available unit of measurement.
            let indexCurrPin = this.options.unitPinUnits.indexOf(this.options.pin);
            let indexNextPin = (indexCurrPin+1)%this.options.unitPinUnits.length;

            // Update the unit of measurement.
            this.options.pin = this.options.unitPinUnits[indexNextPin];
            this._unitPin.innerHTML = this.options.unitPinLabel[this.options.pin];
            this._unitPin.title = this.options.unitPinTitle.text +" [" + this.options.unitPinTitle[this.options.pin]  + "]";
        ...
        _onKeyDown: function (e) {
            if (e.keyCode === 27) {
                ...
                if (this._resumeFirstpointFlag === true) {
                    ...
                    if(this.options.pin === 'home'){
                        this._arrPolylines[lineNr].circleMarkers [0].setStyle (this.options.startCircleHome);
                        this._arrPolylines[lineNr].circleMarkers [0].classList.add(this.options.startCircleHome.id);
                    }else if(this.options.pin === 'pedastal'){
                        this._arrPolylines[lineNr].circleMarkers [0].setStyle (this.options.startCirclePedastal);
                    }else if(this.options.pin === 'handhole'){
                        this._arrPolylines[lineNr].circleMarkers [0].setStyle (this.options.startCircleHandhole);
                    }else{
        ...
        _startLine: function (clickCoords) {
            ...
            this._currentLine = {
                ...
                handleMarkers: function (latlng, pin) {
                    ...
                    if (lastCircleMarker) {
                        ...
                        if (this.circleMarkers.length === 1) {
                            if(this.pin === 'home'){
                                lastCircleMarker.setStyle (polylineState.options.startCircleHome);
                                pinColor = polylineState.options.startCircleHome.fillColor;
                            }else if(this.pin === 'pedastal'){
                                lastCircleMarker.setStyle (polylineState.options.startCirclePedastal);
                                pinColor = polylineState.options.startCirclePedastal.fillColor;
                            }else if(this.pin === 'handhole'){
                                lastCircleMarker.setStyle (polylineState.options.startCircleHandhole);
                                pinColor = polylineState.options.startCircleHandhole.fillColor;
                            }else{
                                lastCircleMarker.setStyle (polylineState.options.startCircle);
                                pinColor = polylineState.options.startCircle.fillColor;
                            }
                        } else {
                ...
                addPoint: function (mouseCoords) {
                    ...
                    this.handleMarkers (mouseCoords, this.pin);
                },
        ...
        _resumeFirstpointClick: function (e) {
            ...
            if(this.options.pin === 'home'){
                var newCircleMarker = new L.CircleMarker (e.latlng, this.options.startCircleHome).addTo(this._layerPaint);
            }else if(this.options.pin === 'pedastal'){
                var newCircleMarker = new L.CircleMarker (e.latlng, this.options.startCirclePedastal).addTo(this._layerPaint);
            }else if(this.options.pin === 'handhole'){
                var newCircleMarker = new L.CircleMarker (e.latlng, this.options.startCircleHandhole).addTo(this._layerPaint);
            }else{
                ...
                if ((this._layerPaint.hasLayer (this._rubberlinePath)) && (lineNr === this._currentLine.id)) {
                  ...
                  if(this._currentLine.circleMarkers.length === 1) {
                    ...
                    if(this._currentLine.circleMarkers.length === 1) {
                        ...
                        if(this.options.pin === 'home'){
                            this._currentLine.circleMarkers [0].setStyle (this.options.startCircleHome);
                        }else if(this.options.pin === 'pedastal'){
                            this._currentLine.circleMarkers [0].setStyle (this.options.startCirclePedastal);
                        }else if(this.options.pin === 'handhole'){
                            this._currentLine.circleMarkers [0].setStyle (this.options.startCircleHandhole);
                        }else{
